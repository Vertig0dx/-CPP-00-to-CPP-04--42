...
/*   Updated: 2024/12/18 16:44:53 by lmiguel-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main (void){
	...
	{
	std::cout << std::endl;
	std::cout << "-----ANIMAL CLASS INSTANCE TESTING COMENCING-----" << std::endl;
	std::cout << std::endl;

	//A_Animal NewAnimal1;
	//^ THIS SHOULD NOT BE ALLOWED, SINCE A_Animal IS A PURE VIRTUAL
